...
//-----------------------------------------------
void draw_a_segm(signed short x_b,signed short y_b)
	{
	draw(x_b+2,y_b+20,8,0,0);
	draw(x_b+2,y_b+19,8,0,0);
	}

//-----------------------------------------------
void draw_b_segm(signed short x_b,signed short y_b)
	{
	draw(x_b+10,y_b+11,0,9,0);
	draw(x_b+9,y_b+11,0,9,0);
	}
//-----------------------------------------------
void draw_c_segm(signed short x_b,signed short y_b)
	{
	draw(x_b+10,y_b+2,0,9,0);
	draw(x_b+9,y_b+2,0,9,0);
	}

//-----------------------------------------------
void draw_d_segm(signed short x_b,signed short y_b)
	{
	draw(x_b+2,y_b+2,8,0,0);
	draw(x_b+2,y_b+1,8,0,0);
	}

//-----------------------------------------------
void draw_e_segm(signed short x_b,signed short y_b)
	{
	draw(x_b+1,y_b+2,0,9,0);
	draw(x_b+2,y_b+2,0,9,0);
	}

//-----------------------------------------------
void draw_f_segm(signed short x_b,signed short y_b)
	{
	draw(x_b+1,y_b+11,0,9,0);
	draw(x_b+2,y_b+11,0,9,0);

	}

//-----------------------------------------------
void draw_g_segm(signed short x_b,signed short y_b)
	{
	draw(x_b+2,y_b+11,8,0,0);
	draw(x_b+2,y_b+10,8,0,0);
	}


//-----------------------------------------------
void print_simb(char in,signed short x_b,signed short y_b)
	{
	if(in=='0')
		{
		draw_a_segm(x_b,y_b);
		...
		{
		draw(x_b+2,y_b+1,0,10,0);
		draw(x_b+3,y_b+1,0,10,0);

		draw(x_b+4,y_b+6,2,0,0);
		draw(x_b+5,y_b+7,2,0,0);
		draw(x_b+6,y_b+8,2,0,0);
		draw(x_b+7,y_b+9,2,0,0);
		draw(x_b+8,y_b+10,2,0,0);

		draw(x_b+5,y_b+6,2,0,0);
		draw(x_b+6,y_b+5,2,0,0);
		draw(x_b+7,y_b+4,2,0,0);
		draw(x_b+8,y_b+3,2,0,0);
		draw(x_b+9,y_b+2,2,0,0);
		draw(x_b+10,y_b+1,2,0,0);

		}

	else if(in=='V')
		{
		draw(x_b+2,y_b+5,0,11,0);
		draw(x_b+3,y_b+5,0,11,0);

		draw(x_b+10,y_b+5,0,11,0);
		draw(x_b+11,y_b+5,0,11,0);

		draw(x_b+3,y_b+4,2,0,0);
		draw(x_b+9,y_b+4,2,0,0);
		draw(x_b+4,y_b+3,2,0,0);
		draw(x_b+8,y_b+3,2,0,0);
		draw(x_b+5,y_b+2,2,0,0);
		draw(x_b+7,y_b+2,2,0,0);
		draw(x_b+6,y_b+1,2,0,0);
/*		draw(x_b+6,y_b+8,2,0,0);
		draw(x_b+7,y_b+9,2,0,0);
		draw(x_b+8,y_b+10,2,0,0);
		...
		draw(x_b+6,y_b+1,0,10,0);
		draw(x_b+7,y_b+1,0,10,0);

		draw(x_b+10,y_b+1,0,9,0);
		draw(x_b+11,y_b+1,0,9,0);

		draw(x_b+2,y_b+9,8,0,0);
		draw(x_b+2,y_b+10,8,0,0);
/*		draw(x_b+6,y_b+8,2,0,0);
		draw(x_b+7,y_b+9,2,0,0);
		draw(x_b+8,y_b+10,2,0,0);
		...
		{
		draw(x_b+2,y_b-2,0,13,0);
		draw(x_b+3,y_b-2,0,13,0);

		draw(x_b+1,y_b-3,2,0,0);

		//draw(x_b+3,y_b+4,2,0,0);
		draw(x_b+3,y_b+3,2,0,0);
		draw(x_b+4,y_b+2,6,0,0);
		draw(x_b+5,y_b+1,5,0,0);
...
*/
	...
	/*	draw(x_b+2,y_b+9,8,0,0);
		...
		{
		draw(x_b+2,y_b+1,0,13,0);
		draw(x_b+3,y_b+1,0,13,0);

		draw(x_b+10,y_b+1,0,14,0);
		draw(x_b+11,y_b+1,0,14,0);

		//draw(x_b+3,y_b+12,2,0,0);
		//draw(x_b+9,y_b+12,2,0,0);
		//draw(x_b+3,y_b+13,2,0,0);
		draw(x_b+3,y_b+14,2,0,0);
		draw(x_b+4,y_b+15,8,0,0);
		draw(x_b+5,y_b+16,6,0,0);
	/*	draw(x_b+6,y_b+15,2,0,0);*/

		draw(x_b+3,y_b+5,8,0,0);
		draw(x_b+3,y_b+6,8,0,0);
	/*	draw(x_b+4,y_b+3,2,0,0);
		draw(x_b+8,y_b+3,2,0,0);
		draw(x_b+5,y_b+2,2,0,0);
		draw(x_b+7,y_b+2,2,0,0);
...
/*		draw(x_b+6,y_b+8,2,0,0);
		...
		{
		draw(x_b+2,y_b+1,2,0,0);
		draw(x_b+2,y_b+2,2,0,0);
		}
	}
